 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const E="10.1.0";function _(t,e={}){let n=t;if("object"!=typeof e){e={name:e}}const r=Object.assign({name:d,automaticDataCollectionEnabled:!1},e),s=r.name;if("string"!=typeof s||!s)throw x.create("bad-app-name",{appName:String(s)});if(n||(n=(0,o.getDefaultAppConfig)()),!n)throw x.create("no-options");const a=p.get(s);if(a){if((0,o.deepEqual)(n,a.options)&&(0,o.deepEqual)(r,a.config))return a;throw x.create("duplicate-app",{appName:s})}const c=new(0,i.ComponentContainer)(s);for(const t of m.values())c.addComponent(t);const l=new k(n,r,c);return p.set(s,l),l}function T(t=d){const e=p.get(t);if(!e&&t===d&&(0,o.getDefaultAppConfig)())return _();if(!e)throw x.create("no-app",{appName:t});return e}function I(t,e,n){var r;let s=null!==(r=f[t])&&void 0!==r?r:t;n&&(s+=`-${n}`);const o=s.match(/\s|\//),a=e.match(/\s|\//);if(o||a){const t=[`Unable to register library "${s}" with version "${e}":`];return o&&t.push(`library name "${s}" contains illegal characters (whitespace or "/")`),o&&a&&t.push("and"),a&&t.push(`version name "${e}" contains illegal characters (whitespace or "/")`),void h.warn(t.join(" "))}y(new(0,i.Component)(`${s}-version`,(()=>({library:s,version:e})),"VERSION"))}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const He=new _(3e4,6e4);function $e(){const t=ce().___jsl;if(null==t?void 0:t.H)for(const e of Object.keys(t.H))if(t.H[e].r=t.H[e].r||[],t.H[e].L=t.H[e].L||[],t.H[e].r=[...t.H[e].L],t.CP)for(let e=0;e<t.CP.length;e++)t.CP[e]=null}let Ke=null;function Ge(t){return Ke=Ke||function(t){return new Promise(((e,n)=>{var i,r,s;function o(){$e(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{$e(),n(m(t,"network-request-failed"))},timeout:He.get()})}if(null===(r=null===(i=ce().gapi)||void 0===i?void 0:i.iframes)||void 0===r?void 0:r.Iframe)e(gapi.iframes.getContext());else{if(!(null===(s=ce().gapi)||void 0===s?void 0:s.load)){const e=ft("iframefcb");return ce()[e]=()=>{gapi.load?o():n(m(t,"network-request-failed"))},dt(`https://apis.google.com/js/api.js?onload=${e}`).catch((t=>n(t)))}o()}})).catch((t=>{throw Ke=null,t}))}(t),Ke}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * limitations under the License.
 */
class pt{constructor(t){this.fields=t,t.sort(z.comparator)}static empty(){return new pt([])}unionWith(t){let e=new dt(z.comparator);for(const t of this.fields)e=e.add(t);for(const n of t)e=e.add(n);return new pt(e.toArray())}covers(t){for(const e of this.fields)if(e.isPrefixOf(t))return!0;return!1}isEqual(t){return P(this.fields,t.fields,((t,e)=>t.isEqual(e)))}}
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pe=new lt(V.comparator);function Me(){return Pe}const Ue=new lt(V.comparator);function Fe(...t){let e=Ue;for(const n of t)e=e.insert(n.key,n);return e}function Be(t){let e=Ue;return t.forEach(((t,n)=>e=e.insert(t,n.overlayedDocument))),e}function je(){return Ve()}function ze(){return Ve()}function Ve(){return new De((t=>t.toString()),((t,e)=>t.isEqual(e)))}const qe=new lt(V.comparator),We=new dt(V.comparator);function He(...t){let e=We;for(const n of t)e=e.add(n);return e}const $e=new dt(D);function Ke(){return $e}
/**
 * @license
 * Copyright 2020 Google LLC
 *
