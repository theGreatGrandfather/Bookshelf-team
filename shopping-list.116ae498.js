 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ki(e,t){return e.tenantId&&!t.tenantId?Object.assign(Object.assign({},t),{tenantId:e.tenantId}):t}async function Gi(e,t,n,r,i={}){return Ji(e,i,(async()=>{let i={},s={};r&&("GET"===t?s=r:i={body:JSON.stringify(r)});const o=ur(Object.assign({key:e.config.apiKey},s)).slice(1),a=await e._getAdditionalHeaders();return a["Content-Type"]="application/json",e.languageCode&&(a["X-Firebase-Locale"]=e.languageCode),zi.fetch()(Xi(e,e.config.apiHost,n,o),Object.assign({method:t,headers:a,referrerPolicy:"no-referrer"},i))}))}async function Ji(e,t,n){e._canInitEmulator=!1;const r=Object.assign(Object.assign({},qi),t);try{const t=new Qi(e),i=await Promise.race([n(),t.promise]);t.clearNetworkTimeout();const s=await i.json();if("needConfirmation"in s)throw Zi(e,"account-exists-with-different-credential",s);if(i.ok&&!("errorMessage"in s))return s;{const t=i.ok?s.errorMessage:s.error.message,[n,o]=t.split(" : ");if("FEDERATED_USER_ID_ALREADY_LINKED"===n)throw Zi(e,"credential-already-in-use",s);if("EMAIL_EXISTS"===n)throw Zi(e,"email-already-in-use",s);if("USER_DISABLED"===n)throw Zi(e,"user-disabled",s);const a=r[n]||n.toLowerCase().replace(/[_\s]+/g,"-");if(o)throw Di(e,a,o);Ni(e,a)}}catch(t){if(t instanceof rr)throw t;Ni(e,"network-request-failed",{message:String(t)})}}async function Yi(e,t,n,r,i={}){const s=await Gi(e,t,n,r,i);return"mfaPendingCredential"in s&&Ni(e,"multi-factor-auth-required",{_serverResponse:s}),s}function Xi(e,t,n,r){const i=`${t}${n}?${r}`;return e.config.emulator?Vi(e.config,i):`${e.config.apiScheme}://${i}`}class Qi{constructor(e){this.auth=e,this.timer=null,this.promise=new Promise(((e,t)=>{this.timer=setTimeout((()=>t(Li(this.auth,"network-request-failed"))),Wi.get())}))}clearNetworkTimeout(){clearTimeout(this.timer)}}function Zi(e,t,n){const r={appName:e.name};n.email&&(r.email=n.email),n.phoneNumber&&(r.phoneNumber=n.phoneNumber);const i=Li(e,t,r);return i.customData._tokenResponse=n,i}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ca=new Hi(3e4,6e4);function ua(){const e=So().___jsl;if(null==e?void 0:e.H)for(const t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let t=0;t<e.CP.length;t++)e.CP[t]=null}let la=null;function ha(e){return la=la||function(e){return new Promise(((t,n)=>{var r,i,s;function o(){ua(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{ua(),n(Li(e,"network-request-failed"))},timeout:ca.get()})}if(null===(i=null===(r=So().gapi)||void 0===r?void 0:r.iframes)||void 0===i?void 0:i.Iframe)t(gapi.iframes.getContext());else{if(!(null===(s=So().gapi)||void 0===s?void 0:s.load)){const t=Ns("iframefcb");return So()[t]=()=>{gapi.load?o():n(Li(e,"network-request-failed"))},Ps(`https://apis.google.com/js/api.js?onload=${t}`).catch((e=>n(e)))}o()}})).catch((e=>{throw la=null,e}))}(e),la}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
