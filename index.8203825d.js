 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xa="The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.";class Wa{constructor(){this.onCommittedListeners=[]}addOnCommittedListener(t){this.onCommittedListeners.push(t)}raiseOnCommittedEvent(){this.onCommittedListeners.forEach((t=>t()))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ja(t){if(t.code!==Ta.FAILED_PRECONDITION||t.message!==Xa)throw t;ga("LocalStore","Unexpectedly lost primary lease")}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ql{}class Xl extends Ql{constructor(t,e,n){super(),this.field=t,this.op=e,this.value=n}static create(t,e,n){return t.isKeyField()?"in"===e||"not-in"===e?this.createKeyFieldInFilter(t,e,n):new ru(t,e,n):"array-contains"===e?new au(t,n):"in"===e?new lu(t,n):"not-in"===e?new uu(t,n):"array-contains-any"===e?new cu(t,n):new Xl(t,e,n)}static createKeyFieldInFilter(t,e,n){return"in"===e?new iu(t,n):new su(t,n)}matches(t){const e=t.data.field(this.field);return"!="===this.op?null!==e&&this.matchesComparison(Rl(e,this.value)):null!==e&&kl(this.value)===kl(e)&&this.matchesComparison(Rl(e,this.value))}matchesComparison(t){switch(this.op){case"<":return t<0;case"<=":return t<=0;case"==":return 0===t;case"!=":return 0!==t;case">":return t>0;case">=":return t>=0;default:return wa()}}isInequality(){return["<","<=",">",">=","!=","not-in"].indexOf(this.op)>=0}getFlattenedFilters(){return[this]}getFilters(){return[this]}getFirstInequalityField(){return this.isInequality()?this.field:null}}class Wl extends Ql{constructor(t,e){super(),this.filters=t,this.op=e,this.ce=null}static create(t,e){return new Wl(t,e)}matches(t){return Jl(this)?void 0===this.filters.find((e=>!e.matches(t))):void 0!==this.filters.find((e=>e.matches(t)))}getFlattenedFilters(){return null!==this.ce||(this.ce=this.filters.reduce(((t,e)=>t.concat(e.getFlattenedFilters())),[])),this.ce}getFilters(){return Object.assign([],this.filters)}getFirstInequalityField(){const t=this.le((t=>t.isInequality()));return null!==t?t.field:null}le(t){for(const e of this.getFlattenedFilters())if(t(e))return e;return null}}function Jl(t){return"and"===t.op}function Yl(t){return Zl(t)&&Jl(t)}function Zl(t){for(const e of t.filters)if(e instanceof Wl)return!1;return!0}function tu(t){if(t instanceof Xl)return t.field.canonicalString()+t.op.toString()+Dl(t.value);if(Yl(t))return t.filters.map((t=>tu(t))).join(",");{const e=t.filters.map((t=>tu(t))).join(",");return`${t.op}(${e})`}}function eu(t,e){return t instanceof Xl?(n=t,(r=e)instanceof Xl&&n.op===r.op&&n.field.isEqual(r.field)&&Nl(n.value,r.value)):t instanceof Wl?function(t,e){return e instanceof Wl&&t.op===e.op&&t.filters.length===e.filters.length&&t.filters.reduce(((t,n,r)=>t&&eu(n,e.filters[r])),!0)}(t,e):void wa();var n,r}function nu(t){return t instanceof Xl?`${(e=t).field.canonicalString()} ${e.op} ${Dl(e.value)}`:t instanceof Wl?function(t){return t.op.toString()+" {"+t.getFilters().map(nu).join(" ,")+"}"}(t):"Filter";var e}class ru extends Xl{constructor(t,e,n){super(t,e,n),this.key=qa.fromName(n.referenceValue)}matches(t){const e=qa.comparator(t.key,this.key);return this.matchesComparison(e)}}class iu extends Xl{constructor(t,e){super(t,"in",e),this.keys=ou("in",e)}matches(t){return this.keys.some((e=>e.isEqual(t.key)))}}class su extends Xl{constructor(t,e){super(t,"not-in",e),this.keys=ou("not-in",e)}matches(t){return!this.keys.some((e=>e.isEqual(t.key)))}}function ou(t,e){var n;return((null===(n=e.arrayValue)||void 0===n?void 0:n.values)||[]).map((t=>qa.fromName(t.referenceValue)))}class au extends Xl{constructor(t,e){super(t,"array-contains",e)}matches(t){const e=t.data.field(this.field);return Ml(e)&&Ll(e.arrayValue,this.value)}}class lu extends Xl{constructor(t,e){super(t,"in",e)}matches(t){const e=t.data.field(this.field);return null!==e&&Ll(this.value.arrayValue,e)}}class uu extends Xl{constructor(t,e){super(t,"not-in",e)}matches(t){if(Ll(this.value.arrayValue,{nullValue:"NULL_VALUE"}))return!1;const e=t.data.field(this.field);return null!==e&&!Ll(this.value.arrayValue,e)}}class cu extends Xl{constructor(t,e){super(t,"array-contains-any",e)}matches(t){const e=t.data.field(this.field);return!(!Ml(e)||!e.arrayValue.values)&&e.arrayValue.values.some((t=>Ll(this.value.arrayValue,t)))}}
/**
 * @license
 ...
 * limitations under the License.
 */
class Xc{constructor(){this.sn=new Wc}addToCollectionParentIndex(t,e){return this.sn.add(e),Ya.resolve()}getCollectionParents(t,e){return Ya.resolve(this.sn.getEntries(e))}addFieldIndex(t,e){return Ya.resolve()}deleteFieldIndex(t,e){return Ya.resolve()}getDocumentsMatchingTarget(t,e){return Ya.resolve(null)}getIndexType(t,e){return Ya.resolve(0)}getFieldIndexes(t,e){return Ya.resolve([])}getNextCollectionGroupToUpdate(t){return Ya.resolve(null)}getMinOffset(t,e){return Ya.resolve(Ha.min())}getMinOffsetFromCollectionGroup(t,e){return Ya.resolve(Ha.min())}updateCollectionGroup(t,e,n){return Ya.resolve()}updateIndexEntries(t,e){return Ya.resolve()}}class Wc{constructor(){this.index={}}add(t){const e=t.lastSegment(),n=t.popLast(),r=this.index[e]||new dl(Va.comparator),i=!r.has(n);return this.index[e]=r.add(n),i}has(t){const e=t.lastSegment(),n=t.popLast(),r=this.index[e];return r&&r.has(n)}getEntries(t){return(this.index[t]||new dl(Va.comparator)).toArray()}}
/**
 * @license
 * Copyright 2019 Google LLC
 *
