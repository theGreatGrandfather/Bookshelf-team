 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mo{constructor(){this._=void 0}}function yo(t,e,n){return t instanceof Eo?To(t,e):t instanceof _o?bo(t,e):n}function vo(t,e){return t instanceof Co?Zi(n=e)||(s=n)&&"doubleValue"in s?e:{integerValue:0}:null;var n,s}class wo extends mo{}class Eo extends mo{constructor(t){super(),this.elements=t}}function To(t,e){const n=Io(e);for(const e of t.elements)n.some((t=>Qi(t,e)))||n.push(e);return{arrayValue:{values:n}}}class _o extends mo{constructor(t){super(),this.elements=t}}function bo(t,e){let n=Io(e);for(const e of t.elements)n=n.filter((t=>!Qi(t,e)));return{arrayValue:{values:n}}}class Co extends mo{constructor(t,e){super(),this.serializer=t,this.Te=e}}function So(t){return Vi(t.integerValue||t.doubleValue)}function Io(t){return tr(t)&&t.arrayValue.values?t.arrayValue.values.slice():[]}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Qo,Ho;function Xo(t){switch(t){default:return Vs();case js.CANCELLED:case js.UNKNOWN:case js.DEADLINE_EXCEEDED:case js.RESOURCE_EXHAUSTED:case js.INTERNAL:case js.UNAVAILABLE:case js.UNAUTHENTICATED:return!1;case js.INVALID_ARGUMENT:case js.NOT_FOUND:case js.ALREADY_EXISTS:case js.PERMISSION_DENIED:case js.FAILED_PRECONDITION:case js.ABORTED:case js.OUT_OF_RANGE:case js.UNIMPLEMENTED:case js.DATA_LOSS:return!0}}function Wo(t){if(void 0===t)return Os("GRPC error has no .code"),js.UNKNOWN;switch(t){case Qo.OK:return js.OK;case Qo.CANCELLED:return js.CANCELLED;case Qo.UNKNOWN:return js.UNKNOWN;case Qo.DEADLINE_EXCEEDED:return js.DEADLINE_EXCEEDED;case Qo.RESOURCE_EXHAUSTED:return js.RESOURCE_EXHAUSTED;case Qo.INTERNAL:return js.INTERNAL;case Qo.UNAVAILABLE:return js.UNAVAILABLE;case Qo.UNAUTHENTICATED:return js.UNAUTHENTICATED;case Qo.INVALID_ARGUMENT:return js.INVALID_ARGUMENT;case Qo.NOT_FOUND:return js.NOT_FOUND;case Qo.ALREADY_EXISTS:return js.ALREADY_EXISTS;case Qo.PERMISSION_DENIED:return js.PERMISSION_DENIED;case Qo.FAILED_PRECONDITION:return js.FAILED_PRECONDITION;case Qo.ABORTED:return js.ABORTED;case Qo.OUT_OF_RANGE:return js.OUT_OF_RANGE;case Qo.UNIMPLEMENTED:return js.UNIMPLEMENTED;case Qo.DATA_LOSS:return js.DATA_LOSS;default:return Vs()}}(Ho=Qo||(Qo={}))[Ho.OK=0]="OK",Ho[Ho.CANCELLED=1]="CANCELLED",Ho[Ho.UNKNOWN=2]="UNKNOWN",Ho[Ho.INVALID_ARGUMENT=3]="INVALID_ARGUMENT",Ho[Ho.DEADLINE_EXCEEDED=4]="DEADLINE_EXCEEDED",Ho[Ho.NOT_FOUND=5]="NOT_FOUND",Ho[Ho.ALREADY_EXISTS=6]="ALREADY_EXISTS",Ho[Ho.PERMISSION_DENIED=7]="PERMISSION_DENIED",Ho[Ho.UNAUTHENTICATED=16]="UNAUTHENTICATED",Ho[Ho.RESOURCE_EXHAUSTED=8]="RESOURCE_EXHAUSTED",Ho[Ho.FAILED_PRECONDITION=9]="FAILED_PRECONDITION",Ho[Ho.ABORTED=10]="ABORTED",Ho[Ho.OUT_OF_RANGE=11]="OUT_OF_RANGE",Ho[Ho.UNIMPLEMENTED=12]="UNIMPLEMENTED",Ho[Ho.INTERNAL=13]="INTERNAL",Ho[Ho.UNAVAILABLE=14]="UNAVAILABLE",Ho[Ho.DATA_LOSS=15]="DATA_LOSS";
/**
 * @license
 * Copyright 2023 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fh{constructor(){this.Qi=!1}initialize(t,e){this.Ki=t,this.indexManager=e,this.Qi=!0}getDocumentsMatchingQuery(t,e,n,s){return this.$i(t,e).next((i=>i||this.Ui(t,e,s,n))).next((n=>n||this.Wi(t,e)))}$i(t,e){if(Ur(e))return yi.resolve(null);let n=$r(e);return this.indexManager.getIndexType(t,n).next((s=>0===s?null:(null!==e.limit&&1===s&&(e=zr(e,null,"F"),n=$r(e)),this.indexManager.getDocumentsMatchingTarget(t,n).next((s=>{const i=uo(...s);return this.Ki.getDocuments(t,i).next((s=>this.indexManager.getMinOffset(t,n).next((n=>{const r=this.Gi(e,s);return this.zi(e,r,i,n.readTime)?this.$i(t,zr(e,null,"F")):this.ji(t,r,e,n)}))))})))))}Ui(t,e,n,s){return Ur(e)||s.isEqual(si.min())?this.Wi(t,e):this.Ki.getDocuments(t,n).next((i=>{const r=this.Gi(e,i);return this.zi(e,r,n,s)?this.Wi(t,e):(Ls()<=h.LogLevel.DEBUG&&Ms("QueryEngine","Re-using previous result from %s to execute query: %s",s.toString(),Hr(e)),this.ji(t,r,e,ui(s,-1)))}))}Gi(t,e){let n=new xi(Yr(t));return e.forEach(((e,s)=>{Xr(t,s)&&(n=n.add(s))})),n}zi(t,e,n,s){if(null===t.limit)return!1;if(n.size!==e.size)return!0;const i="F"===t.limitType?e.last():e.first();return!!i&&(i.hasPendingWrites||i.version.compareTo(s)>0)}Wi(t,e){return Ls()<=h.LogLevel.DEBUG&&Ms("QueryEngine","Using full collection scan to execute query:",Hr(e)),this.Ki.getDocumentsMatchingQuery(t,e,di.min())}ji(t,e,n,s){return this.Ki.getDocumentsMatchingQuery(t,n,s).next((t=>(e.forEach((e=>{t=t.insert(e.key,e)})),t)))}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
